    ...
    <div class="container">
        ...
        <div class="service_wrapper">
            ...
            @foreach($services as $key => $service)
                ...
                @if($key == 0 || $key%3 == 0)
                    <div class="row {{ $key != 0 ? 'borderTop' : NULL }}">
                @endif

                    <div class="col-lg-4 {{ $key%3 > 0 ? 'borderLeft' : NULL }} {{ $key > 2 ? 'mrgTop' : NULL }}">
...
<section id="Portfolio" class="content">
    ...
    <div class="portfolio">
        @if(isset($portfolio_tags) && is_object($portfolio_tags))
            <!-- Portfolio Filters -->
        ...
        <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper">
            ...
            <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four {{ $portfolio_item->filter }} isotope-item">
                <div class="portfolio_img">{{ Html::image('assets/img/'.$portfolio_item->images, $portfolio_item->name) }}</div>
    ...
    <div class="container">
        ...
        <div class="team_section clearfix">
            ...
            <div class="team_area">
                ...
                <h3 class="wow fadeInDown delay-0{{ $key*3 + 3 }}s">{{ $item->name }}</h3>
                <span class="wow fadeInDown delay-0{{ $key*3 + 3 }}s">{{ $item->position }}</span>
                <p class="wow fadeInDown delay-0{{ $key*3 + 3 }}s">{{ $item->text }}</p>
            </div>
            @endforeach
...
<footer class="footer_wrapper" id="contact">
    ...
    <div class="container">
        <div class="footer_bottom"><span>Copyright © 2014,    Template by <a href="">WebThemez.com</a>. </span> </div>
    </div>
</footer>